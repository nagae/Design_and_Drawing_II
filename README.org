* 重要連絡 / Important Message (2015.10.21 update)
** English version of the scoring rule for the first half is added.
The scoring rule for the first half (out of 100 pts) is added to the end section of this document.
The final score for this subject is evaluated as an average of the first half and the second (fractions are rounded up).
...
* 前半の評価 / Evaluation of the first half
- 長江担当分の成績(100点満点)は，課題1〜3 の点数を用いて以下のように成績を評価
  する：
  1. 課題1を10点として，課題2(100点)と課題3(100点)の点数の合計を2で割ったもの
     に加えたものを「素点」とする．
  2. 「素点」が50点未満の場合は，「素点」+10点を「長江担当分の成績」とする
  3. 「素点」が50点以上60点未満の場合は，60点を「長江担当分の成績」とする
