...
- 10/14 :: 休講
  - Solidworks がインストールできないなどの対応を希望する学生は TAの二人にその旨をメールで知らせること
...
- 10/21 :: 第2回 チュートリアルの図面提出，レイアウトスケッチの利用方法の解説，基本形状の課題発表
  ...
  - *課題2*: [[file:2014-Exercise2.pdf][課題2ファイル]] に基づいて基本形状の部品を作成し，その部品ファイルを提出せよ(提出期限: 11月4日，提出方法: メール．下記参照．)．
    ...
    *Report 2*: Build the basic shapes (基本形状) in [[file:2014-Exercise2.pdf][Report 2 file]] and submit their part files via e-mail (nagae@m.tohoku.ac.jp). Deadline is *11/4*.
  ...
  - 課題は下記に従い *メール* で提出すること．ルールを守らない場合は *減点* する．
    ...
    1. 宛先は長江と2名のTAとせよ．メールアドレスは講義中に指示する．
       The e-mail should be sent to Dr. Nagae and two TAs (E-mail address would be indicated in the lecture).
