...
=solidworks**_****.zip= をエクスプローラの標準機能(e.g. ダブルクリックや右クリックメニューで「全て展開」)で
解凍するとインストーラが途中で止まる現象が報告されています. [[http://www.7-zip.org][7-zip]] を利用して下さい．

It is reported that SolidWorks Installer might stop if you extract
...
** SolidWorks 2015 のネットワークライセンス認証
...
The Network License can not be activated via eduroam network as 
